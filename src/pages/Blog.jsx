        ...
        <div className="divide-y divide-gray-200">
          <div className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
            ...
            <div className="flex flex-col">
              ...
              <textarea type="text" className="h-20 px-2 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600" placeholder="Address" />
            </div>
            ...
            <div className="flex items-center space-x-4">
              <div className="flex flex-col">
                ...
                <div className="relative focus-within:text-gray-600 text-gray-400">
                  <input type="file" className="pr-4 pl-10 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600" placeholder="25/02/2020" />
              ...
              <div className="flex flex-col">
                ...
                <div className="relative focus-within:text-gray-600 text-gray-400">
                  <input type="file" className="pr-4 pl-10 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600" placeholder="26/02/2020" />
